    ...
    <section id="experience" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="bg-gradient-to-br from-red-500/10 via-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-3xl border border-slate-700/50 p-8 md:p-12 shadow-2xl hover:shadow-red-500/20 transition-all duration-300">
            <div className="grid md:grid-cols-[200px_1fr] gap-8 items-center">
              ...
              >
                <div className="w-40 h-40 bg-black rounded-2xl flex items-center justify-center border-2 border-red-500/30 shadow-lg shadow-red-500/20">
                  {/* TEDx Logo Placeholder - Replace with actual logo */}
                  <div className="text-center">
                    <div className="text-5xl font-bold text-white mb-1">TED</div>
                    <div className="text-2xl font-bold">
                      <span className="text-white">x</span>
                      <span className="text-red-500">CRCE</span>
                    </div>
                  </div>
                </div>
              </motion.div>
